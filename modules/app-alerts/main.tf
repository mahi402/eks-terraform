...
resource "aws_cloudwatch_dashboard" "error_metric_include2" {
  ...
  dashboard_name = "${var.cluster_name}-${var.pod_name}-dashboard"
  dashboard_body = local.template_dashboard_body
}
...
module "cloudwatchalarm_cpu" {
  ...
  alarm_name          = "${var.cluster_name}_${var.pod_name}_cpu_utilization"
  tags                = var.tags
...
module "cloudwatchalarm_memory" {
  ...
  source              = "./cloudwatch-alarm-notify"
  alarm_name          = "${var.cluster_name}_${var.pod_name}_memory_utilization"
  tags                = var.tags
  comparison_operator = "GreaterThanOrEqualToThreshold"
  evaluation_periods  = "1"
  period              = var.memory_period
...
#   name             = "${var.cluster_name}_${var.pod_name}"
...
module "cloudwatchalarm_error" {
  count               = var.enable_error_filter ? 1 : 0
  source              = "./cloudwatch-alarm-notify"
  alarm_name          = "${var.cluster_name}_${var.pod_name}_error_utilization"
  tags                = var.tags
  comparison_operator = "GreaterThanOrEqualToThreshold"
  evaluation_periods  = "1"
  period              = var.error_period
...
module "cloudwatchalarm_network_tx" {
  ...
  source              = "./cloudwatch-alarm-notify"
  alarm_name          = "${var.cluster_name}_${var.pod_name}_network_tx_utilization"
  tags                = var.tags
  comparison_operator = "GreaterThanOrEqualToThreshold"
  evaluation_periods  = "1"
  period              = var.network_period
...
module "cloudwatchalarm_network_rx" {
  count               = var.enable_network_threshold ? 1 : 0
  source              = "./cloudwatch-alarm-notify"
  alarm_name          = "${var.cluster_name}_${var.pod_name}_network_rx_utilization"
  tags                = var.tags
  comparison_operator = "GreaterThanOrEqualToThreshold"
  evaluation_periods  = "1"
  period              = var.network_period
...
module "cloudwatchalarm_restart_count" {
  ...
  source              = "./cloudwatch-alarm-notify"
  alarm_name          = "${var.cluster_name}_${var.pod_name}_restart_count"
  tags                = var.tags
