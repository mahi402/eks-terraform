...
variable "parameter_cidr1" {
  type        = string
  description = "Name of the cidr1 id stored in aws_ssm_parameter"
}

variable "parameter_cidr2" {
  type        = string
  description = "Name of the cidr2 id stored in aws_ssm_parameter"
}

variable "parameter_cidr3" {
  type        = string
  description = "Name of the cidr3 id stored in aws_ssm_parameter"
}
